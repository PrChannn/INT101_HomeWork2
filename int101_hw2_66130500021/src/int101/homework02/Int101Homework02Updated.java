...
public class Int101Homework02Updated {
    ...
    static void testString() {
        System.out.println(Utilitor.testString("Proud"));
        System.out.println(Utilitor.testString(null));
        System.out.println(Utilitor.testString(""));
    }
    
    static void testPositive() {
        System.out.println("The number is : " + Utilitor.testPositive(5));
        System.out.println("The number is : " + Utilitor.testPositive(-8));
    }
    
    static void testComputeIsbn10() {
        System.out.println(Utilitor.computeIsbn10(184938562));
    }
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        Person p1 = new Person("Chanya", "Nimt");
        Person p2 = new Person("Marry","Mike");
